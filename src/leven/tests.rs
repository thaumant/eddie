use super::{Leven, MAX_CHARS};

#[test]
fn leven_dist_equality() {
    let lv = Leven::new();
    let sample = [
        "",
        "c",
...
#[test]
fn leven_dist_del_intermittent() {
    let lv = Leven::new();
    let s2 = "captain";
    let sample = [
        (1, "_captain"),
...
#[test]
fn leven_dist_add_intermittent() {
    let lv = Leven::new();
    let s1 = "captain";
    let sample = [
        (1, "_captain"),
...
#[test]
fn leven_dist_sub_intermittent() {
    let lv = Leven::new();
    let s1 = "captain";
    let sample = [
        (1, "_aptain"),
